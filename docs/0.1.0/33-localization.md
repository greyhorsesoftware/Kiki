...
**Status:** plan, written 2026-09-21. Nothing here is built. Whether it lands before the 0.1.0 tag or after it is the owner's call; it touches every file with a word in it, so it should not run alongside another phase.
