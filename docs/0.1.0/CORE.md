...
| 19 | `19-ai-query.md` | 3, 4, 6, 13, 14 | Jarvis ▸ Query… on text files: a chat panel, local answers for counts, Claude through a helper process with credentials from env, keyring or the `ant` CLI (ships after 14, before 10) |
