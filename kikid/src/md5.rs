//! MD5 (RFC 1321), used only for freedesktop thumbnail cache keys. Not for security.
...
mod tests {
    ...
    fn known_vectors() {
        ...
        assert_eq!(super::hex(b"The quick brown fox jumps over the lazy dog"), "9e107d9d372bb6826bd81d3542a419d6");
    }
}
